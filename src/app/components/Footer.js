...
const Footer = () => {
    return (
        <Box component="footer" sx={{ width: '100%', mt: { xs: '15px', sm: '25px', md: '35px' } }}>
            <Grid container spacing={4} sx={{px: { xs: '15px', sm: '30px', md: '75px' }, py: '50px', textAlign: { xs: 'center', sm: 'center', sm: 'left' } }}>
                <Grid item xs={12} sm={12} md={6}>
                    <Stack spacing={2} alignItems={{ xs: 'center', sm: 'center', md: 'flex-start' }}> 
                        <Image src={Logo} alt="Logo" />
                        <Box sx={{ width: { xs: '100%', sm: '100%', md: '55%' } }}>
                            <Typography variant="body2" sx={{ fontFamily: 'Inter', fontSize: '15px', fontWeight: 500, lineHeight: '31.13px', color: '#111', }}>
                                Founded in 2024. Step into a new era of video creation with Viralvision where innovative tools meet effortless storytelling for viral success!
                            </Typography>
                        </Box>
                ...
                <Grid item xs={12} sm={12} md={6}>
                    <Grid container spacing={4}> 
                        ...
                        <Grid item xs={12} sm={4} md={4}>
                            <Typography variant="h6" sx={{ fontSize: '22px', fontWeight: 600, lineHeight: '26.4px', letterSpacing: '0.02em',  color: '#111', }} gutterBottom>
                                Quick Links
                            </Typography>
                            <Stack spacing={1}>
